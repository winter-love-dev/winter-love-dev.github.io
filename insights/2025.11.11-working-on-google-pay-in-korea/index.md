...
치열했던 과거 1~2분기로 되돌아가서 어떤 과정들이 있었나 떠올려보자. 

관련 문서들을 살펴봤다.
먼저 살펴본 [Stripe 측 가이드 문서 (Stripe)](https://docs.stripe.com/google-pay?platform=android) 를 읽다보면 나를 냅다 
[구글페이 관련 공식 설명문서 (GooglePay)](https://developers.google.com/pay/api/android/guides/setup) 로 리다이렉팅 시킨다.
여기서 우리 프로젝트에 해줘야 할 첫 번 째 기초적인 설정들에 대해 알 수 있게 된다.
문서 가이드대로 프로젝트쪽 설정을 해주자.

그리고 [구글 월렛 콜솔 (GooglePay)](https://pay.google.com/business/console/) 이라는 관리 콘솔의 존재를 인지하게 된다.
